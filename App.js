  ...
  return (
    <div>
      ...
      <div className='movie-container'>
        <MoviesCard name={movies[0].title} year={movies[0].year} img={movies[0].img} />
        <MoviesCard name={movies[1].title} year={movies[1].year} img={movies[1].img} />
        <MoviesCard name={movies[2].title} year={movies[2].year} img={movies[2].img} />
        <MoviesCard name={movies[3].title} year={movies[3].year} img={movies[3].img} />
        <MoviesCard name={movies[4].title} year={movies[4].year} img={movies[4].img} />
      </div>
    </div>
  );
}
